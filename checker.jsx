...
"यदि आपके साथ निकटता एक युद्ध है, तो मुझे युद्धों से प्यार है!"`;
        ...
        const i18n = {
            ar: {
                ...
                login: { title: "يوم ميلاد <span className='font-script text-[rgb(196,13,116)] text-shimmer px-1 font-bold'>صَـبـا</span> 👑", day: "يوم", month: "شهر", year: "سنة", btn: "فتح الصندوق", quote: "اليوم اللي اتولدتي فيه هو بداية الحياة..." },
                ...
                clock1: { title: "اكتملت هديتك يا أجمل صبا! ✨", subtitle: "كل نجمة في السما بتشهد على حبي ليكي... نورتي دنيتي يا ست البنات", year: "سنين", month: "شهور", day: "أيام", hour: "ساعات", min: "دقائق", sec: "ثواني" },
                clock2: { title: "يوم ميلاد أفضل حد في حياتي 🎂✨", subtitle: "منذ (9/5/2025)", year: "سنين", month: "شهور", day: "أيام", hour: "ساعات", min: "دقائق", sec: "ثواني" },
                ...
                timeline: {
                    items: [
                        ...
                        { pic: "saba1.jpg", text: "يا أحلى اختياراتي 💍", desc: "لو الأيام رجعت بيا ألف مرة، هختارك إنتي برضه، مفيش حد يقدر يملا مكانك." },
                        { pic: "saba2.jpg", text: "كل دنيتي ومستقبلي 🌍", desc: "أنا مش شايف مستقبلي غير بيكي ومعاكي، ربنا يخليكي ليا يا أغلى حاجة عندي." }
                    ]
                }
            },
            en: {
        ...
        const LoveNote = ({ lang }) => {
            ...
            const messages = {
                ar: [
                    ...
                    "ضحكتك بتنور دنيتي يا <span className='font-script text-[rgb(196,13,116)] text-shimmer px-1 font-bold'>صَـبـا</span> ✨",
